...
> "我们站在巨人的肩膀上，是为了看得更远，而不是为了成为巨人脚下的阴影。这个项目，就是让你把任何强大的
> AI 服务，都变成你自己的'巨人'。"
...
`langfast-2api` 是一个轻量级高性能代理服务，核心使命是将
**[langfast](https://langfa.st)** 原生接口无缝转换为完全兼容 **OpenAI API**
的格式。

🔗 **仓库地址**:
[https://github.com/lzA6/langfast-2api](https://github.com/lzA6/langfast-2api)
...
请查看 [LICENSE](LICENSE) 文件获取完整条款，或访问
[Apache 2.0 协议官网](https://www.apache.org/licenses/LICENSE-2.0)。
